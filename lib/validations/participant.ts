...
export const participantCreateSchema = z.object({
  ...
  target_distance_km: z.number().min(1, 'Målsatt distanse må være minst 1 km').max(1000, 'Målsatt distanse kan ikke være mer enn 1000 km'),
});
...
export const participantUpdateSchema = z.object({
  ...
  target_distance_km: z.number().min(1, 'Målsatt distanse må være minst 1 km').max(1000, 'Målsatt distanse kan ikke være mer enn 1000 km').optional(),
});
