...
import { ImageViewerDialogMulti } from '@/components/gallery-viewer/image-viewer-dialog-multi'
...
import type { CompletionWithParticipant, CompletionImage } from '@/lib/types/database'
