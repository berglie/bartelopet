    ...
    <div className="container max-w-4xl py-8">
      ...
      <article className="prose prose-zinc dark:prose-invert max-w-none prose-headings:text-foreground prose-p:text-foreground prose-li:text-foreground prose-strong:text-foreground">
        ...
        <ul>
          ...
          <li>Du har nødvendig helsemessig tilstand for å gjennomføre løpet og har konsultert lege ved tvil</li>
          <li>Arrangøren ikke er ansvarlig for skader, uhell, tap, personskade, død eller annet som oppstår i forbindelse med løpet</li>
        </ul>

        <h3>7.1 Trafikksikkerhet og påkjørselsrisiko</h3>
        <p>
          Løypen går gjennom områder med biltrafikk, og deltakerne løper i mørke og under varierende værforhold. Du erkjenner og aksepterer uttrykkelig at:
        </p>
        <ul>
          <li>Det foreligger reell risiko for å bli påkjørt av kjøretøy, syklister eller andre trafikanter</li>
          ...
          <li>Du må bruke refleks, hodelykt eller annet sikkerhetsutstyr som du selv anser nødvendig</li>
          <li>Du må stoppe for rødt lys, gi førselen til kjøretøy der det er påkrevd, og ellers følge alle trafikksignaler</li>
          <li>Du skal ikke løpe på en måte som skaper fare for deg selv eller andre</li>
          <li>Arrangøren ikke har sperret veier, regulerer trafikk, eller på annen måte kontrollerer trafikkforholdene</li>
          <li>Arrangøren ikke er ansvarlig for trafikkulykker, påkjørsler eller andre trafikkskader</li>
        </ul>

        <h3>7.2 Løping i mørke og varierende forhold</h3>
        <p>
          Løpet gjennomføres i november måned, ofte i mørke, ved dårlig vær og under utfordrende forhold. Du aksepterer at:
        </p>
        <ul>
          ...
          <li>Arrangøren ikke er ansvarlig for skader som oppstår som følge av værforhold, mørke eller underlagsforhold</li>
        </ul>

        <h3>7.3 Generelt ansvarsfraskrivelse</h3>
        <p>
          Arrangøren fraskriver seg uttrykkelig ethvert ansvar for:
        </p>
        <ul>
          ...
          <li>Skader som følge av overanstrengelse, dehydrering, hypotermi eller andre helsemessige forhold</li>
        ...
        <p>
          Ved å delta i løpet bekrefter du at du har lest, forstått og akseptert denne ansvarsbegrensningen, og at du frivillig påtar deg all risiko forbundet med deltakelse i arrangementet.
        </p>
