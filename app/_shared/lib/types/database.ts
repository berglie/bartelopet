...
export type CompletionImageUpdate = Partial<
  Pick<CompletionImage, 'caption' | 'display_order' | 'is_starred'>
>;
...
export type ParticipantInsert = Omit<
  Participant,
  'id' | 'created_at' | 'updated_at' | 'has_completed'
>;

export type CompletionInsert = Omit<
  Completion,
  'id' | 'created_at' | 'updated_at' | 'vote_count' | 'comment_count' | 'image_count'
>;
...
export type CompletionUpdate = Partial<
  Pick<Completion, 'completed_date' | 'duration_text' | 'comment'>
>;
