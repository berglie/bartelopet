...
export const rateLimiters = {
  ...
  comment: redis && isRedisAvailable
    ? new Ratelimit({
        redis,
  ...
  account: redis && isRedisAvailable
    ? new Ratelimit({
        redis,
        limiter: Ratelimit.slidingWindow(10, '1 h'),
        analytics: true,
