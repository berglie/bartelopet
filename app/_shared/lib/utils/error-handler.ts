 ...
 */
export function sanitizeError(error: unknown, context: ErrorLogContext): string {
 ...
 */
export function sanitizeSupabaseError(error: unknown, context: ErrorLogContext): string {
