...
export function ContestantHistory({ history, participantName }: ContestantHistoryProps) {
  ...
  const bestYear = history.reduce(
    (best, current) => (current.voteCount > best.voteCount ? current : best),
    history[0]
  );
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Oversikt over {participantName}s deltakelse år for år</CardDescription>
        </CardHeader>
        <CardContent>
