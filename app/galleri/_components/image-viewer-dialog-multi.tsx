...
import { CompletionWithParticipant, PhotoCommentWithParticipant, CompletionImage } from '@/app/_shared/lib/types/database'
    ...
    >
      ...
      <button
        ...
        className={cn(
          ...
          'md:left-8',
          isFirstCompletion && currentImageIndex === 0 && 'cursor-not-allowed opacity-30 hover:bg-black/50'
        )}
      ...
      <button
        ...
        className={cn(
          ...
          'md:right-8',
          isLastCompletion && currentImageIndex === completionImages.length - 1 && 'cursor-not-allowed opacity-30 hover:bg-black/50'
        )}
          ...
          <div className="mx-auto max-w-5xl p-6 md:p-8">
            <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <Heart
                    className={cn('h-5 w-5 transition-all', hasVoted && 'fill-current')}
                  />
